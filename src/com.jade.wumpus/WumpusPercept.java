...
public class WumpusPercept {
    ...
    private String[] breatheVar = new String[]{"I feel breeze here. ", "There is a breeze. ", "It's a cool breeze here. "};
    private String[] stenchVar = new String[]{"I feel stench here. ", "There is a stench. ", "It's a stench here. "};
    private String[] glitterVar = new String[]{"I see glitter here. ", "There is a glitter. ", "It's a glitter here. "};
    private String[] screamVar = new String[]{"I hear scream. ", "There is a scream. ", "It's a scream here. "};
