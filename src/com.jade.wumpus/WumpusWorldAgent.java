...
public class WumpusWorldAgent extends Agent {
    ...
    protected void setup() {
        System.out.println("Hello! The Wumpus world agent " + getAID().getName() + " is ready.");
        System.out.println("WumpusWorldAgent: Current world state:");
    ...
    protected void takeDown() {
        ...
        System.out.println("The Wumpus world agent " + getAID().getName() + " terminating.");
    }
    ...
    private class WumpusWorldGamePerforming extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if (msg != null) {
                String message = msg.getContent();
                System.out.println("WumpusWorldAgent: Current world state before the action:");
                System.out.println(cave);
                ...
                switch (message){
                    ...
                    case Constants.SPELEOLOGIST_CLIMB: if (climb()) { sendWinMessage = true; sendTerminateMessage = true;} break;
                    default: System.out.println("WumpusWorldAgent: Wrong action!"); break;
                }

                System.out.println("WumpusWorldAgent: Current world state after the action:");
                System.out.println(cave);
    ...
    final static class Constants {
        ...
        static final String INITIAL_WUMPUS_CAVE = ". . . P W G P . . . . . S . P . ";
        ...
        static final String ADVICE_PROPOSAL = "Help, what i need to do?";
        static final String INFORMATION_PROPOSAL_NAVIGATOR = "Give me your position.";
        static final String INFORMATION_PROPOSAL_SPELEOLOGIST = "Position: ";
        static final String ACTION_PROPOSAL1 = "It seems to me you should ";
        static final String ACTION_PROPOSAL2 = "It would be a good idea to ";
        static final String ACTION_PROPOSAL3 = "I think you can ";
