...
public class SpeleologistAgent extends Agent {
    ...
    protected void setup() {
        System.out.println("Hello! The speleologist agent " + getAID().getName() + " is ready.");
    ...
    protected void takeDown() {
        System.out.println("The speleologist agent " + getAID().getName() + " terminating.");
    }
        ...
        public void action() {
            switch (step) {
                case 0:
                    ...
                    System.out.println("SpeleologistAgent: " + WumpusWorldAgent.Constants.ADVICE_PROPOSAL);
                    myAgent.send(inform);
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.REQUEST) {
                            if (parseNavigatorMessageRequest(reply.getContent())) {
                                ...
                                System.out.println("SpeleologistAgent: There is an unknown command!");
                        }
                    } else {
                ...
                case 2:
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.INFORM) {
                            ...
                            System.out.println("SpeleologistAgent: " + WumpusWorldAgent.Constants.INFORMATION_PROPOSAL_SPELEOLOGIST + rep);
                            myAgent.send(mes);
                            mt = MessageTemplate.and(MessageTemplate.MatchConversationId(WumpusWorldAgent.Constants.NAVIGATOR_DIGGER_CONVERSATION_ID),
                        ...
                        if (reply.getPerformative() == ACLMessage.PROPOSE) {
                            ...
                            switch (action) {
                                ...
                                case Commands.CLIMB:
                                    ...
                                    break;
                                default:
                                    System.out.println("SpeleologistAgent: There is no right action!");
                                    break;
                            }
                    ...
                    if (reply != null) {
                        ...
                        switch (answer) {
                            case WumpusWorldAgent.Constants.FAIL_MESSAGE:
                                System.out.println("SpeleologistAgent: You failed!");
                                step++;
                                doDelete();
                                break;
                            case WumpusWorldAgent.Constants.OK_MESSAGE:
                                System.out.println("SpeleologistAgent: Wumpus world answers OK.");
                                step = 0;
                                break;
                            case WumpusWorldAgent.Constants.WIN_MESSAGE:
                                System.out.println("SpeleologistAgent: The speleologist survived and won!");
                                step++;
                                doDelete();
                                break;
                        }
